...
def upgrade() -> None:
    ...
    op.create_table('mcp_registry_cache',
    ...
    op.create_index(op.f('ix_mcp_registry_cache_registry_id'), 'mcp_registry_cache', ['registry_id'], unique=True)
    op.create_table('tenants',
    sa.Column('name', sa.String(length=255), nullable=False),
    sa.Column('slug', sa.String(length=255), nullable=False),
    sa.Column('plan', sa.Enum('FREE', 'PRO', 'BUSINESS', 'ENTERPRISE', name='tenant_plan'), nullable=False),
    ...
    sa.Column('role', sa.Enum('ADMIN', 'CREATOR', 'USER', name='user_role'), nullable=False),
    ...
    sa.Column('agent_type', sa.Enum('CUSTOM', 'OOB', 'VERTICAL', name='agent_type'), nullable=False),
    sa.Column('category', sa.String(length=100), nullable=True),
    sa.Column('is_published', sa.Boolean(), nullable=False),
    sa.Column('marketplace_price', sa.Numeric(precision=10, scale=2), nullable=True),
    ...
    op.create_index('ix_agents_tenant_created', 'agents', ['tenant_id', 'created_at'], unique=False)
    op.create_index(op.f('ix_agents_tenant_id'), 'agents', ['tenant_id'], unique=False)
    op.create_table('user_mcp_connections',
    ...
    op.create_index('ix_mcp_conn_tenant_user', 'user_mcp_connections', ['tenant_id', 'user_id'], unique=False)
    op.create_index(op.f('ix_user_mcp_connections_tenant_id'), 'user_mcp_connections', ['tenant_id'], unique=False)
    op.create_index(op.f('ix_user_mcp_connections_user_id'), 'user_mcp_connections', ['user_id'], unique=False)
    ...
    sa.ForeignKeyConstraint(['mcp_connection_id'], ['user_mcp_connections.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index('ix_agent_mcp_tools_agent', 'agent_mcp_tools', ['agent_id', 'mcp_connection_id'], unique=False)
    op.create_index(op.f('ix_agent_mcp_tools_agent_id'), 'agent_mcp_tools', ['agent_id'], unique=False)
    op.create_index(op.f('ix_agent_mcp_tools_mcp_connection_id'), 'agent_mcp_tools', ['mcp_connection_id'], unique=False)
    op.create_table('executions',
    sa.Column('agent_id', sa.UUID(), nullable=False),
    sa.Column('user_id', sa.UUID(), nullable=False),
    sa.Column('input_message', sa.Text(), nullable=False),
    sa.Column('output_message', sa.Text(), nullable=True),
    sa.Column('status', sa.Enum('RUNNING', 'COMPLETED', 'FAILED', 'CANCELLED', name='execution_status'), nullable=False),
    ...
    op.create_index('ix_executions_user_agent', 'executions', ['user_id', 'agent_id'], unique=False)
    ...
    sa.Column('status', sa.Enum('PROCESSING', 'READY', 'FAILED', name='kb_status'), nullable=False),
    ...
    op.create_index('ix_kb_tenant_created', 'knowledge_bases', ['tenant_id', 'created_at'], unique=False)
    ...
    op.create_index('ix_reviews_agent', 'reviews', ['agent_id', 'created_at'], unique=False)
    op.create_index(op.f('ix_reviews_agent_id'), 'reviews', ['agent_id'], unique=False)
    op.create_index('ix_reviews_user_agent', 'reviews', ['user_id', 'agent_id'], unique=False)
    ...
    op.create_index('ix_subscriptions_user_agent', 'subscriptions', ['user_id', 'agent_id'], unique=False)
    op.create_index(op.f('ix_subscriptions_user_id'), 'subscriptions', ['user_id'], unique=False)
    op.create_table('usage_records',
    sa.Column('user_id', sa.UUID(), nullable=False),
    sa.Column('agent_id', sa.UUID(), nullable=True),
    sa.Column('record_type', sa.Enum('EXECUTION', 'TOKEN', 'STORAGE', name='record_type'), nullable=False),
    ...
    op.create_index('ix_usage_tenant_created', 'usage_records', ['tenant_id', 'created_at'], unique=False)
    op.create_index('ix_usage_user_type', 'usage_records', ['user_id', 'record_type'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_agent_mcp_tools_mcp_connection_id'), table_name='agent_mcp_tools')
    ...
    op.drop_index(op.f('ix_user_mcp_connections_user_id'), table_name='user_mcp_connections')
    op.drop_index(op.f('ix_user_mcp_connections_tenant_id'), table_name='user_mcp_connections')
    ...
    op.drop_index(op.f('ix_mcp_registry_cache_registry_id'), table_name='mcp_registry_cache')
