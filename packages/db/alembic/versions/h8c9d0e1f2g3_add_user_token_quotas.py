...
def upgrade() -> None:
    # User token quotas
    _add_col_if_missing("users", sa.Column("token_monthly_allowance", sa.Integer(), nullable=True))
    _add_col_if_missing("users", sa.Column("tokens_used_this_month", sa.Integer(), server_default="0", nullable=False))
    _add_col_if_missing("users", sa.Column("cost_monthly_limit", sa.Numeric(10, 2), nullable=True))
    _add_col_if_missing("users", sa.Column("cost_used_this_month", sa.Numeric(10, 4), server_default="0", nullable=False))
    _add_col_if_missing("users", sa.Column("quota_reset_at", sa.DateTime(timezone=True), nullable=True))
    ...
    _add_col_if_missing("api_keys", sa.Column("max_monthly_tokens", sa.Integer(), nullable=True))
    _add_col_if_missing("api_keys", sa.Column("tokens_used", sa.Integer(), server_default="0", nullable=False))
    _add_col_if_missing("api_keys", sa.Column("max_monthly_cost", sa.Numeric(10, 2), nullable=True))
    _add_col_if_missing("api_keys", sa.Column("cost_used", sa.Numeric(10, 4), server_default="0", nullable=False))
